...
<div class="inner">
    ...
    <div class="category-intro">
        ...
        <h2>第一種銃猟免許の取得費用と審査</h2>
        <p>
        第一種銃猟免許は、散弾銃やライフル銃を使用するために必要です。取得には申請手数料や講習費用のほか、銃本体の購入費、ガンロッカーや装弾ロッカーの設置費用、狩猟保険料といった多くの出費が発生します。また、公安委員会の審査を経て初めて所持許可が与えられます。
        </p>
        <p>
        本カテゴリでは、第一種銃猟免許の試験問題を学習できるだけでなく、取得に必要な費用や審査の流れについても解説しています。合格後の準備にも役立ててください。
        </p>
    </div>
