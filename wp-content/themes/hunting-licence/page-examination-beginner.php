...
<div class="main-visual schedule">
  <div class="inner">
    ...
    <p class="align-center"><button class="question-btn"><a href="#schedule">エリアごとのスケジュールを見る</a></button></p>
  </div>
</div>
...
<div class="contents study-method">
  <div class="inner">
    ...
    <div class="cta-btns">
      <p><a class="btn" href="<?php echo home_url('/category/examination/'); ?>">初心者考査の過去問へ</a></p>
      <p><a class="btn sub" href="<?php echo home_url('/gun-cost/'); ?>">所持許可の費用まとめ</a></p>
    </div>
    ...
    <h2 id="schedule">【47都道府県】公式スケジュールリンク</h2>
    <?php
    // ========== ヘルパー ==========
