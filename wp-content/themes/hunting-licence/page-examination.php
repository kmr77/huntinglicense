...
<div class="contents">
  <div class="inner">
    ...
    <h2>狩猟免許試験とは？</h2>
      <p>
        狩猟免許試験は、<strong>第一種銃猟免許・第二種銃猟免許・網猟免許・罠猟免許</strong>の4種類があり、年2回（前期・後期）に各都道府県ごとに実施されます。<br>
        試験では「適性検査」「筆記試験」「実技試験」が行われ、狩猟を行うために必要な知識・技能が問われます。
      </p>

      <h2>試験日程について</h2>
      <p>
        最新の日程は都道府県ごとに発表されます。下記リンクから詳細な一覧をご確認ください。<br>
        👉 <a href="<?php echo home_url('/schedule/'); ?>">狩猟免許試験 日程一覧はこちら</a>
      </p>
    <h2>講習会の基礎知識</h2>
    <ul>
