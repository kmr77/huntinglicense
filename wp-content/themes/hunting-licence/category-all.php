...
<?php if ( !is_paged() ) : ?>
      ...
      <h2>狩猟免許取得に必要な費用と準備</h2>
      <p>
      狩猵免許を取得するには、試験対策だけでなく、公安委員会による審査や狩猟者登録、講習の受講などが必要です。申請手数料や講習費用に加え、猟銃の購入費、ガンロッカーや装弾ロッカーの設置、狩猟保険料といった多くの支出を計画する必要があります。
      </p>
      <p>
      当サイトでは、全カテゴリの試験問題を効率的に学習できるだけでなく、費用の目安や公安委員会の手続き、装備の準備についても解説しています。学習と資金計画を同時に進め、合格と安全な狩猟生活に備えてください。
      </p>
