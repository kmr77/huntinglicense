...
<?php if ( !is_paged() ) : ?>
    <div class="category-intro">
        ...
        <p>
            第二種銃猟免許は、空気銃を使用して狩猟を行うために必要な資格です。第一種に比べて扱う銃は軽量ですが、取得にかかる講習費用や申請手数料、銃購入費や保管庫の設置費用など、必要な支出は決して少なくありません。また公安委員会の審査を受け、適正な保管設備を備えていなければ所持許可は得られません。本カテゴリでは、第二種銃猟免許の試験問題を収録するとともに、取得や維持にかかる費用や準備の流れについても触れています。
        </p>
        ...
        <h2>第二種銃猟免許と必要な費用</h2>
        <p>
        第二種銃猟免許は、空気銃を扱うために必要です。講習費用や申請手数料に加え、銃の購入費や保管庫の設置費用、狩猟保険料など、維持にかかる支出も考慮しなければなりません。公安委員会の審査を通過して、適切な保管環境を整える必要があります。
        </p>
        <p>
        このカテゴリでは、第二種銃猟免許の試験問題を解きながら、取得に伴う費用や安全管理の流れを理解できます。効率よく合格を目指してください。
        </p>
    </div>
