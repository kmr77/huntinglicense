...
<?php if ( !is_paged() ) : ?>
  ...
  <h2>公安委員会の審査と法令遵守</h2>
  <p>
  狩猟免許や猟銃の所持には、公安委員会の審査と法令遵守が不可欠です。申請では講習や適性検査、身辺調査が行われ、基準を満たさなければ許可が下りません。さらに、銃の保管にはガンロッカーや装弾ロッカーの設置が義務づけられています。
  </p>
  <p>
  本カテゴリでは、法令問題の過去問を解きながら、公安委員会の審査内容や関連規定について理解を深められます。安全で確実な免許取得を目指してください。
  </p>
