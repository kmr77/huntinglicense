jQuery(function($) {
    ...
    function set_settings() {
        var csviae_settings = $.cookie("csviae-settings");
        if (!csviae_settings) {
            return false;
        }
        ...
        csviae_settings = JSON.parse(csviae_settings);
        $.each(csviae_settings, function(index, setting) {
            var $content = null;
    ...
    function save_settings() {
        ...
        $.cookie("csviae-settings", json_settings);
    }
