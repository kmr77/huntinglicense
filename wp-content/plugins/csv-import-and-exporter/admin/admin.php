...
<script type="text/javascript">
    jQuery(function($) {
        ...
        foreach ($post_types as $post_type) :
            if ($post_type->name == 'post' || $post_type->name == 'page' || isset($csviae_post_type)) :
                ?>
            ...
            foreach ($post_types as $post_type) :
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="number" name="limit" class="limit" value="0" min="0" data-target=".offset-<?php echo esc_attr($post_type->name) ?>"> <?php $this->e('*All downloaded if "0" selected.', '※0の場合はすべてダウンロード') ?>
                                                <div class="offset offset-<?php echo esc_attr($post_type->name) ?>" style="display:none;">
                                                    <br><input type="number" name="offset" class="offset_input" value="0" min="0"> <?php $this->e('*Number of posts to start', '※ダウンロードする記事の開始位置') ?>
                                                </div>
                ...
                <?php else : ?>
                    <div class="plugin_content">
                        ...
                        <p><a href="<?php echo esc_url($this->setting_url('setting')); ?>"><?php $this->e('WP CSV Exporter Add-Ons') ?></a></p>
                    </div>
            <?php
                endif;
            endforeach;
